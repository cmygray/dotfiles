...
local on_attach = function(client, bufnr)
  ...
  -- 진단 관련 키맵
  vim.keymap.set('n', '<leader>j', function() vim.diagnostic.goto_next() end, bufopts)
  vim.keymap.set('n', '<leader>k', function() vim.diagnostic.goto_prev() end, bufopts)
...
local servers = { 'ts_ls', 'jsonls', 'yamlls', 'lua_ls', 'marksman', 'pyright', 'html', 'bashls' }

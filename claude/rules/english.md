...
- Only correct English the user wrote when it has a real grammar or phrasing mistake. For Korean-only messages, URLs, commands, code, logs, names, quotes, or already-natural English, stay silent.
